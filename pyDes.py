...
# MODIFICATION LOG
# Feb-2009: rlc
#   - add password reader _getDESpw() 
#     asks for a user password and conforms it to an 8-byte field
#   - removed triple-DES, since I don't need it.
